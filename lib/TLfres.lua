...
function TLfres.setScreen(m, extent, centered, stretch)
	...
	love.window.setMode(m.w,m.h, {fullscreen = m.full, vsync = m.vsync,msaa =  m.aa})
	love.mouse.setVisible(v)
	
	w, h = m.w>0 and m.w or love.graphics.getWidth(), m.h>0 and m.h or love.graphics.getHeight()
